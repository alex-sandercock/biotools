...
![PCA concept diagram](../../images/pca-concept.png){fig-alt="Diagram showing how PCA reduces dimensions while preserving structure"}

### Reading a PCA Plot

Each dot is one sample. Samples close together are **genetically similar**.

![Example PCA plot](../../images/pca-example.png){fig-alt="PCA plot showing two distinct clusters of samples"}
...
![Running PCA in BIGapp](../../images/bigapp-pca.gif){fig-alt="Animated GIF showing the PCA workflow in BIGapp"}

**Steps:**

1. Make sure you have filtered data loaded
2. Go to **"PCA"** in the sidebar
3. Click **Run PCA**
...
1. Run PCA on your filtered data
...
![PCA with clear clusters](../../images/pca-clusters.png){fig-alt="PCA showing distinct population clusters"}
...
![PCA with continuous variation](../../images/pca-continuous.png){fig-alt="PCA showing continuous spread without distinct clusters"}
...
![PCA with outliers](../../images/pca-outliers.png){fig-alt="PCA showing main cluster with outlier samples"}
...
![PCA colored by population](../../images/bigapp-pca-colored.gif){fig-alt="Animated GIF showing how to color PCA by metadata"}

This helps you see if genetic structure matches your expectations.

**Steps:**

1. Upload a metadata file with group labels
2. In the PCA section, select the grouping variable
...
![Scree plot example](../../images/scree-plot.png){fig-alt="Scree plot showing variance explained by each PC"}
...
5. Color by group — does genetic structure match?
