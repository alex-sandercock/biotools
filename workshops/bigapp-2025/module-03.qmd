...
![GWAS concept](../../images/gwas-concept.png){fig-alt="Diagram showing how GWAS tests for association between marker genotypes and phenotype"}

If individuals with allele "A" consistently have higher yield than those with allele "B", that marker is **associated** with yield.
...
![Manhattan plot example](../../images/manhattan-plot.png){fig-alt="Manhattan plot showing -log10 p-values across chromosomes with peaks indicating significant associations"}
...
![Confounding diagram](../../images/gwas-confounding.png){fig-alt="Diagram showing how population structure can confound GWAS results"}
...
![Running GWAS in BIGapp](../../images/bigapp-gwas.gif){fig-alt="Animated GIF showing the GWAS workflow in BIGapp"}

**Steps:**

1. Go to **"GWAS"** in the sidebar
2. Upload or select your phenotype file
3. Select the trait to analyze
...
2. Select a trait from the example phenotypes
3. Run the analysis
4. Check the BIC plot to see how many PCs were automatically selected
5. Look at the Manhattan plot — do you see any significant peaks?
...
![QQ plot example](../../images/qq-plot.png){fig-alt="QQ plot showing observed vs expected p-values with most points on diagonal and deviation at the tail"}
...
1. Run GWAS for one trait
2. Examine the Manhattan plot:
   - How many significant peaks do you see?
   - Which chromosome(s) have the strongest associations?
3. Check the QQ plot:
   - Does it look well-calibrated?
   - Is there evidence of inflation?
4. Look at the top hits:
   - What are the effect sizes?
   - What are the MAFs?

**Discussion:**
- Would you trust these results for marker-assisted selection?
- What additional validation would you want?
