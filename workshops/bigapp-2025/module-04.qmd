...
2. Upload your phenotype file
3. Select the trait to predict
4. Choose the model (rrBLUP is a good default)
...
1. Load the example data with phenotypes
2. Run genomic prediction for a trait
3. What accuracy do you get?
4. Try different models — does accuracy change?
...
BIGapp offers several prediction models:

| Model | Best for | Notes |
|-------|----------|-------|
| **rrBLUP** | Most situations | Fast, assumes many small QTL |
| **GBLUP** | When you have relationship matrix | Uses genomic relationships |
| **Bayesian** | Large-effect QTL | Slower, more flexible |

**Recommendation:** Start with rrBLUP. It works well for most traits in most crops.
...
2. Run genomic prediction for one trait
3. Note the cross-validation accuracy
4. Identify the top 10 individuals by GEBV
5. Run prediction for a different trait — is accuracy similar?

**Discussion questions:**

- Would you use GS for this trait in your program?
...
✅ rrBLUP is a good default model for most situations
